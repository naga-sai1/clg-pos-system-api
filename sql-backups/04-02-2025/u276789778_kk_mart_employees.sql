...
CREATE TABLE `employees` (
  ...
  `employees_first_name` varchar(255) NOT NULL,
  `employees_last_name` varchar(255) NOT NULL,
  `employees_email` varchar(255) NOT NULL,
  `employees_phone` varchar(255) NOT NULL,
...
-- Dump completed on 2025-02-04 16:08:36
